...
var DumbAllocator = (function () {
    function DumbAllocator(ctor) {
        this.ctor = ctor;
    }
    DumbAllocator.prototype.allocate = function (entityID) {
        return new this.ctor;
    };
    DumbAllocator.prototype.release = function (entityID, t) {
        // No-op - just let the object be garbage collected eventually
    };
    return DumbAllocator;
}());
var ComponentType = (function () {
    function ComponentType(componentName, ctor, allocatorCtor) {
        if (allocatorCtor === void 0) { allocatorCtor = DumbAllocator; }
        var _this = this;
...
var PoolAllocator = (function () {
    ...
    PoolAllocator.prototype.allocate = function (entityID) {
        assert(!(entityID in this.entityIDToActiveListIndex));
        return this.freeList.pop() || new this.ctor();
    };
    PoolAllocator.prototype.release = function (entityID, t) {
